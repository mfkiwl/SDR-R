...
# Title: Top Block
# Generated: Fri May 17 11:45:52 2019
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.lofreq / 2, 5e3, firdes.WIN_KAISER, 6.76))
    ...
    def set_lofreq(self, lofreq):
        self.lofreq = lofreq
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.lofreq / 2, 5e3, firdes.WIN_KAISER, 6.76))
        self.analog_sig_source_x_0_0.set_frequency(self.lofreq)
        self.analog_sig_source_x_0.set_frequency(self.lofreq)
